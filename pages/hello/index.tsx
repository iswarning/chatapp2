    ...
    <>
      ...
      <div>
        <div className="layout">
            ...
            <div className="nav-group">
              <ul>
                <li className="logo">
                  <a href="#">
                    <img
                      src="https://tinno.laborasyon.com/dist/media/img/logo.png"
                      alt="logo"
                    />
                  </a>
                </li>
                <li
                  className="navigation-action-button dropright"
                  title="New"
                ...
                >
                  <a
                    href="https://tinno.laborasyon.com/login.html"
                    data-intro-js="3"
                    data-toggle="dropdown"
                    aria-expanded="false"
                  >
                    <figure className="avatar avatar-sm">
                      <img
                        src="https://tinno.laborasyon.com/dist/media/img/avatar9.jpg"
                  ...
                  <div className="dropdown-menu">
                    ...
                    <a
                      href="#"
                      className="dropdown-item d-none d-md-block example-app-tour-start"
                    >
                      Start Tour
                    </a>
          ...
          {/* <div id="chats" className="left-sidebar">
            <div className="left-sidebar-header">
              <div className="story-block">
                <h4 className="mb-4">Stories</h4>
                <div
                  className="story-items mb-4 slick-initialized slick-slider"
                  data-intro-js="4"
                >
                  <div className="slick-list draggable">
                    ...
                    >
                      <div
                        className="story-item slick-slide slick-cloned"
                        tabIndex={-1}
                        style={{ width: "0px" }}
                        data-slick-index="-4"
                        id=""
                        aria-hidden="true"
                      >
                        <a href="#" className="avatar" tabIndex={-1}>
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/avatar7.jpg"
                            className="rounded-circle"
                            alt="image"
                          />
                      ...
                      >
                        <a href="#" className="avatar" tabIndex={-1}>
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/avatar1.jpg"
                            className="rounded-circle"
                            alt="image"
                          />
                      ...
                      >
                        <a href="#" className="avatar" tabIndex={-1}>
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/avatar5.jpg"
                            className="rounded-circle"
                            alt="image"
                          />
                      ...
                      <div
                        className="story-item slick-slide slick-current slick-active"
                        tabIndex={0}
                        style={{ width: "0px" }}
                        data-slick-index="0"
                        aria-hidden="false"
                      >
                        <a
                          href="#"
                          className="avatar avatar-border-primary"
                          tabIndex={0}
                        >
                      ...
                      <div
                        className="story-item slick-slide slick-active"
                        tabIndex={0}
                        style={{ width: "0px" }}
                        data-slick-index="1"
                        aria-hidden="false"
                      >
                        <a
                          href="#"
                          className="avatar avatar-border-success"
                          tabIndex={0}
                        >
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/avatar6.jpg"
                            className="rounded-circle"
                            alt="image"
                          />
                      ...
                      <div
                        ...
                        aria-hidden="false"
                      >
                        <a href="#" className="avatar" tabIndex={0}>
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/avatar2.jpg"
                            className="rounded-circle"
                            alt="image"
                          />
                      ...
                      <div
                        className="story-item slick-slide"
                        tabIndex={-1}
                        style={{ width: "0px" }}
                        data-slick-index="4"
                        aria-hidden="true"
            ...
            <div className="left-sidebar-content ps ps--active-y">
              <ul className="list-group list-group-flush">
                      ...
                      <div className="action-toggle">
                        <div className="dropdown">
                          ...
                          <div className="dropdown-menu dropdown-menu-right">
                            ...
                            <a
                              href="#"
                              className="dropdown-item text-danger example-delete-chat"
                            >
                              Delete
                            </a>
                          </div>
                ...
                <li data-intro-js="5" className="list-group-item">
                ...
                <li className="list-group-item">
                  <figure className="avatar avatar-state-warning mr-3">
                    <img
                      src="https://tinno.laborasyon.com/dist/media/img/avatar4.jpg"
                      className="rounded-circle"
                      alt="image"
                    />
                  </figure>
                ...
                <li className="list-group-item">
                  ...
                  <div className="users-list-body">
                    <div>
                      ...
                      <p>
                        <i className="mdi mdi-check-all text-info mr-1"></i> I
                        need you today. Can you come with me?
                      </p>
                    </div>
                    <div className="users-list-action">
              ...
              <div
                ...
                style={{ top: "0px", height: "498px", right: "0px" }}
              >
                <div
                  className="ps__thumb-y"
                  tabIndex={0}
                  style={{ top: "0px", height: "178px" }}
                ></div>
              </div>
            </div>
          </div> */}

          <div id="friends" className="left-sidebar open">
            <div className="left-sidebar-header">
              <form>
            ...
            <div className="left-sidebar-content ps ps--active-y">
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">
                  <div>
                    <figure className="avatar avatar-state-success mr-3">
                      <img
                        src="https://tinno.laborasyon.com/dist/media/img/avatar3.jpg"
                        className="rounded-circle"
                        alt="image"
                      />
                    </figure>
              ...
              <div
                className="ps__rail-y"
                style={{ top: "0px", right: "0px", height: "629px" }}
              >
                <div
                  className="ps__thumb-y"
                  tabIndex={0}
                  style={{ top: "0px", height: "356px" }}
                ></div>
              </div>
            </div>
          </div>
                ...
                <li className="list-group-item">
                  <div className="users-list-body">
                    <div>
                      <h5>Jennica Kindred</h5>
                      <p>
                        I know how important this file is to you. You can trust
                        me ;)
                      </p>
                    </div>
                    <div className="users-list-action">
            ...
            <div className="no-message-container">
              <div className="row mb-5">
                <div className="col-md-4 offset-4">
                  <img
                    src="https://tinno.laborasyon.com/dist/media/svg/chat_empty.svg"
                    className="img-fluid"
                    alt="image"
                  />
                </div>
              ...
              <p className="lead">
                ...
                <a href="#" data-left-sidebar="friends" className="active">
                  new chat
                </a>
                .
              </p>
              ...
              <div className="chat-header-action">
                <ul className="list-inline" data-intro-js="7">
                  <li className="list-inline-item d-inline d-lg-none">
                    <a
                      href="#"
                      className="btn btn-danger btn-floating example-chat-close"
                    >
                  ...
                  >
                    <a
                      ...
                      data-right-sidebar="notifications"
                    >
                  ...
                  >
                    <a
                      href="#"
                      className="btn btn-success btn-floating voice-call-request"
                    >
                  ...
                  >
                    <a
                      href="#"
                      className="btn btn-warning btn-floating video-call-request"
                    >
                  ...
                  <li className="list-inline-item">
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                      ...
                      <a
                        href="#"
                        className="dropdown-item example-close-selected-chat"
                      >
                        Close chat
                      </a>
                      <a href="#" className="dropdown-item">
                      ...
                      <a href="#" className="dropdown-item example-delete-chat">
                        Delete
                      </a>
                      <div className="dropdown-divider"></div>
                      <a
                        href="#"
                        className="dropdown-item text-danger example-block-user"
                      >
                        Block
                      </a>
                    </div>
            ...
            <div className="chat-body ps ps--active-y">
              <div className="messages">
                  ...
                  <div className="message-content">
                    ...
                    <div className="dropdown">
                      ...
                      <div className="dropdown-menu">
                        ...
                        <a
                          href="#"
                          className="dropdown-item example-delete-message"
                        >
                          Delete
                        </a>
                      </div>
                ...
                <div className="message-item in">
                  <div className="message-content">
                    <div className="message-text">
                      How do you feel today? I want to ask you something.
                    </div>
                    <div className="dropdown">
                      <a href="#" data-toggle="dropdown">
                        <i className="mdi mdi-dots-horizontal"></i>
                  ...
                  <div className="message-content message-file">
                    <div className="message-text d-flex">
                      ...
                      <div>
                        <div>
                          test-filename.pdf{" "}
                          <small className="text-muted small">(50KB)</small>
                        </div>
                        <ul className="list-inline mt-2">
                          <li className="list-inline-item mb-0">
                            <a
                              href="#"
                              className="btn btn-sm btn-light-success btn-floating"
                              title="View"
                            >
                ...
                <div className="message-item out">
                  ...
                  <div className="message-content">
                    <div className="message-text">
                      Thank you so much. These files are very important to me. I
                      guess you didn't make any changes to these files. So I
                      need the original versions of these files. Thank you very
                      much again.
                    </div>
                    <div className="dropdown">
                      <a href="#" data-toggle="dropdown">
                  ...
                  <div className="message-content">
                    <div>
                      <div className="message-content-images">
                        <a
                          href="https://tinno.laborasyon.com/dist/media/img/image1.jpg"
                          data-fancybox="images"
                        >
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/image1.jpg"
                            alt="image"
                          />
                        </a>
                        <a
                          href="https://tinno.laborasyon.com/dist/media/img/image2.jpg"
                          data-fancybox="images"
                        >
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/image2.jpg"
                            alt="image"
                          />
                        </a>
                        <a
                          href="https://tinno.laborasyon.com/dist/media/img/image3.jpg"
                          data-fancybox="images"
                        >
                          <img
                            src="https://tinno.laborasyon.com/dist/media/img/image3.jpg"
                            alt="image"
                          />
                        </a>
                      </div>
                ...
                <div className="message-item out">
                  ...
                  <div className="message-content">
                    <div className="message-text">
                      ...
                      A, exercitationem inventore quaerat quos repellendus sunt?
                      Assumenda dolor earum optio quis?
                    </div>
                    <div className="dropdown">
                      <a href="#" data-toggle="dropdown">
                        <i className="mdi mdi-dots-horizontal"></i>
                ...
                <div
                  className="message-item messages-divider"
                  data-label="1 message unread"
                ></div>
                <div className="message-item in">
                  <div className="message-avatar">
                    <figure className="avatar avatar-sm">
              ...
              <div
                className="ps__rail-y"
                style={{ top: "1920px", height: "568px", right: "0px" }}
              >
                <div
                  className="ps__thumb-y"
                  tabIndex={0}
                  style={{ top: "439px", height: "129px" }}
                ></div>
              </div>
            </div>
              ...
              <li className="list-group-item py-3 px-0 d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <span className="text-muted small">
                      <i className="mdi mdi-clock-outline small mr-1"></i> 50
                      min ago
                    </span>
                  </div>
                </div>
              ...
              <li className="list-group-item py-3 px-0 d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <span className="text-muted small">
                      <i className="mdi mdi-clock-outline small mr-1"></i> 5
                      hour ago
                    </span>
                  </div>
                </div>
              ...
              <li className="list-group-item py-3 px-0 d-flex justify-content-between">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <span className="text-muted small">
                      <i className="mdi mdi-clock-outline small mr-1"></i>{" "}
                      Yesterday
                    </span>
                  </div>
                </div>
        ...
        <div className="right-sidebar" id="user-profile">
          ...
          <div className="right-sidebar-content ps ps--active-y">
                ...
                <div className="mt-4 mb-4">
                  ...
                  <ul className="list-inline social-links">
                    <li className="list-inline-item">
                      <a
                        href="#"
                        className="btn btn-floating btn-facebook"
                        data-toggle="tooltip"
                        title=""
                    ...
                    <li className="list-inline-item">
                      <a
                        href="#"
                        className="btn btn-floating btn-twitter"
                        data-toggle="tooltip"
                        title=""
                    ...
                    <li className="list-inline-item">
                      <a
                        href="#"
                        className="btn btn-floating btn-instagram"
                        data-toggle="tooltip"
                        title=""
            ...
            <div
              className="ps__rail-y"
              style={{ top: "0px", height: "691px", right: "0px" }}
            >
              <div
                className="ps__thumb-y"
                tabIndex={0}
        ...
        >
          <div
            className="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom"
            role="document"
          >
              ...
              <div className="modal-body">
                <div className="row mb-5">
                  <div className="col-md-6 offset-3">
                    <img
                      src="https://tinno.laborasyon.com/dist/media/svg/undraw_warning_cyit.svg"
                      className="img-fluid"
                      alt="image"
                    />
                  </div>
          ...
          >
            <div className="modal-content call-request">
              <div className="modal-body">
                ...
                <h4 className="my-4">
                  Brietta Blogg <span className="text-success">calling...</span>
                </h4>
                <div className="call-action-button">
                  ...
                  <button
                    type="button"
                    className="btn btn-success btn-pulse btn-floating btn-lg voice-call-accept"
                  >
        ...
        <div
          className="modal voice-call fade"
          id="voiceCall"
          tabIndex={-1}
          role="dialog"
          aria-hidden="true"
          ...
          >
            <div className="modal-content">
              <div
                ...
                style={{
                  background:
                    "url(https://tinno.laborasyon.com/dist/media/img/avatar2.jpg)",
                }}
              >
                ...
                <div className="call-action-button">
                  <button
                    type="button"
                    className="btn btn-pulse btn-floating btn-lg mute-event"
                    data-toggle="tooltip"
                    title=""
                    data-original-title="Turn on / off sound"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <button
                    ...
                    title=""
                    data-dismiss="modal"
                    data-original-title="Stop talking"
                  >
                    <i className="mdi mdi-close"></i>
                  </button>
                </div>
        ...
        >
          <div
            className="modal-dialog modal-xl modal-dialog-centered modal-dialog-zoom"
            role="document"
          >
            <div className="modal-content">
              <div
                ...
                style={{
                  background:
                    "url(https://tinno.laborasyon.com/dist/media/img/video-call.jpg)",
                }}
              >
                ...
                <div className="call-action">
                  ...
                  <div className="call-users">
                    <figure
                      ...
                      data-placement="left"
                      title=""
                      data-original-title="Margaretta Worvell"
                    >
                      <img
                        src="https://tinno.laborasyon.com/dist/media/img/avatar2.jpg"
                        className="rounded-circle"
                    ...
                    <figure
                      ...
                      data-placement="left"
                      title=""
                      data-original-title="Matteo Reedy"
                    >
                      <span className="avatar-title bg-info rounded-circle">
                        M
                      </span>
                    ...
                    <figure
                      ...
                      data-placement="left"
                      title=""
                      data-original-title="Townsend Seary"
                    >
                      <img
                        src="https://tinno.laborasyon.com/dist/media/img/avatar1.jpg"
                        className="rounded-circle"
          ...
          >
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form className="mb-4">
                  <div className="form-group">
                    <label htmlFor="invite_emails" className="col-form-label">
                      Email address
                    </label>
                  ...
                  <div className="form-group">
                    <label htmlFor="invite_topic" className="col-form-label">
                      Invitation topic
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  <ul className="list-group list-group-unlined">
                    ...
                    <li className="list-group-item px-0 d-flex">
                      <figure className="avatar mr-3">
                        <img
                          src="https://tinno.laborasyon.com/dist/media/img/avatar10.jpg"
                          className="rounded-circle"
                          alt="image"
                        />
                      </figure>
        ...
        >
          ...
          >
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">
                  <i className="mdi mdi-account-group-outline mr-2"></i> New
                  Group
                </h5>
                <button
                  type="button"
                ...
                <form>
                  ...
                  <div className="form-group">
                    <div className="avatar-group">
                      ...
                      >
                        <img
                          src="https://tinno.laborasyon.com/dist/media/img/avatar8.jpg"
                          className="rounded-circle"
                          alt="image"
                        />
                      </figure>
                      ...
                      <div className="px-3 pb-3">
                        <ul className="list-group list-group-flush">
                          <li className="list-group-item d-flex align-items-center px-0">
                            ...
                            <button
                              type="button"
                              className="btn ml-auto text-primary"
                            >
                              Add
                            </button>
                          </li>
                ...
                <div className="tab-content">
                  ...
                  <div className="tab-pane" id="contact" role="tabpanel">
                    <div className="form-item custom-control custom-switch">
                      ...
                      >
                        Suggest changing passwords every month.
                      </label>
                    </div>
                    <div className="form-item custom-control custom-switch">
                      <input
                      ...
                      >
                        Let me know about suspicious entries to your account
                      </label>
                    </div>
                    <div className="form-item">
                      <p>
                        ...
                        >
                          <i className="mdi mdi-plus mr-2"></i> Security
                          Questions
                        </a>
                      </p>
        ...
        >
          ...
          >
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">
                  <i className="mdi mdi-clipboard-edit-outline mr-2"></i> Edit
                  Profile
                </h5>
                <button
                  type="button"
