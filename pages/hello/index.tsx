...
<a className="-intro-x side-menu__content__link text-gray-600 dark:text-gray-300 relative tooltip py-5" href="settings.html" data-placement="right"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="feather feather-settings w-5 h-5 mx-auto"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg> </a>
</div>
</div>
...
<a href="" className="w-12 mr-3 cursor-pointer tooltip">
<div className="w-12 h-12 flex-none image-fit rounded-full">
<img alt="Topson Messenger Tailwind HTML Admin Template" className="rounded-full" src="https://topson.left4code.com/dist/images/profile-15.jpg"/>
<div className="bg-green-500 border-white w-3 h-3 absolute right-0 bottom-0 rounded-full border-2"></div>
</div>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-white">John Travolta</a>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Brad Pitt</a>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Leonardo DiCaprio</a>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Sylvester Stallone</a>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Johnny Depp</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500</div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Russell Crowe</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomi</div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Arnold Schwarzenegger</a>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Al Pacino</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 20</div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Angelina Jolie</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500</div>
</div>
<div className="flex flex-col">
...
<div className="chat-list box cursor-pointer relative flex items-center px-4 py-3 mt-4 ">
<div className="w-12 h-12 flex-none image-fit mr-1">
<img alt="Topson Messenger Tailwind HTML Admin Template" className="rounded-full" src="https://topson.left4code.com/dist/images/profile-11.jpg"/>
<div className="bg-green-500 border-white w-3 h-3 absolute right-0 bottom-0 rounded-full border-2"></div>
</div>
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Russell Crowe</a>
...
<div className="chat-list box cursor-pointer relative flex items-center px-4 py-3 mt-4 ">
<div className="w-12 h-12 flex-none image-fit mr-1">
<img alt="Topson Messenger Tailwind HTML Admin Template" className="rounded-full" src="https://topson.left4code.com/dist/images/profile-6.jpg"/>
<div className="bg-green-500 border-white w-3 h-3 absolute right-0 bottom-0 rounded-full border-2"></div>
</div>
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Al Pacino</a>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Bruce Willis</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 20</div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="chat-list box cursor-pointer relative flex items-center px-4 py-3 mt-4 ">
<div className="w-12 h-12 flex-none image-fit mr-1">
<img alt="Topson Messenger Tailwind HTML Admin Template" className="rounded-full" src="https://topson.left4code.com/dist/images/profile-8.jpg"/>
<div className="bg-green-500 border-white w-3 h-3 absolute right-0 bottom-0 rounded-full border-2"></div>
</div>
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Keanu Reeves</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomi</div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Christian Bale</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem </div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Tom Cruise</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem </div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="chat-list box cursor-pointer relative flex items-center px-4 py-3 mt-4 ">
<div className="w-12 h-12 flex-none image-fit mr-1">
<img alt="Topson Messenger Tailwind HTML Admin Template" className="rounded-full" src="https://topson.left4code.com/dist/images/profile-2.jpg"/>
<div className="bg-green-500 border-white w-3 h-3 absolute right-0 bottom-0 rounded-full border-2"></div>
</div>
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Kevin Spacey</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500</div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">01:10 PM</div>
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">Denzel Washington</a>
<div className="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500</div>
</div>
<div className="flex flex-col">
<div className="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600">05:09 AM</div>
