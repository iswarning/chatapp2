  ...
  return (
    <>
      <div className="hidden sm:block dropdown relative mr-3 mt-3">
          <MoreVertIcon fontSize='small' onClick={() => setShow(true)}/>
      </div>
      <div className="dropdown-menu w-40 show" style={{width: "160px", position: "absolute", inset: "0px auto auto 0px", margin: "0px", transform: "translate(766.4px, 327.2px)"}}>
