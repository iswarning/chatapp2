...
export default function ChatComponent({ chat, onShowMessage, active }: any) {
...
<div className="ml-2 overflow-hidden">
<a href="javascript:;" className="font-medium text-gray-800 dark:text-white">{ chat.isGroup ? chat.name : recipientSnapshot?.docs?.[0]?.data().fullName}</a>
