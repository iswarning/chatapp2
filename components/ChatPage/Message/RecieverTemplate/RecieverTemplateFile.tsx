...
export default function RecieverTemplateFile({ file, message, chatId, timestamp, lastIndex }: { file: FileInMessageType | undefined, message: MessageType, chatId: string, timestamp: any, lastIndex: boolean }) {
    ...
    <>
    {
        file?.id !== undefined && chunks ? <div className="-intro-x chat-text-box flex items-end float-left mb-4">
